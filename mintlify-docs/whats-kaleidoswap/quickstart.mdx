...
<Steps>
  ...
  <Step title="Fund Your Wallet">
    ...
    2. Choose an account route: Spark, Arkade, Liquid, or RGB-L1
  ...
  <Step title="Connect a Swap Venue">
    ...
    - For RGB swaps, connect an RGB Lightning Node from "Settings" → "RGB" (direct URL or Nostr Wallet Connect)
  </Step>
