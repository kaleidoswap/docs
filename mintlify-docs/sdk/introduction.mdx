...
- **TypeScript SDK**: Pure TypeScript using openapi-fetch with full type inference
- **Python SDK**: Pure Python using httpx with Pydantic models for type-safe development
