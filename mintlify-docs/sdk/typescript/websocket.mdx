...
description: The KaleidoSwap SDK provides real-time data streaming through WebSocket connections for live quotes, market updates, and order status changes.
---
