---
title: Utilities
description: The KaleidoSwap SDK includes utility functions to make your life easier when working with assets and amounts. Think of these as your helpers for the common stuff you'll be doing.
---
