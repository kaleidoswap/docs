...
The API returns **three distinct error envelopes** depending on where the request failed.
...
3. Re-issue any pending `quote_request` messages to obtain fresh quotes.
