...
<Note>
The examples on this page use Signet. Match the WebSocket URL to the environment your `baseUrl` points at — Regtest is the SDK default, at `wss://api.regtest.kaleidoswap.com/ws/{id}`. See [Available Environments](/sdk/getting-started#available-environments).
</Note>
