---
title: "Kaleido SDK Changelog"
sidebarTitle: "Changelog"
description: "Kaleido SDK version history — new features, breaking changes, and RLN and Maker API compatibility notes for each release"
---

<Note>
  This changelog covers the KaleidoSDK (`kaleido-sdk`) and the Maker API (`/api/v1`). For Desktop App releases, see the [GitHub releases page](https://github.com/kaleidoswap/desktop-app/releases).
</Note>
