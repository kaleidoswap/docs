...
Rate is a browser extension wallet designed for Bitcoin Layer 2 networks. It connects to your RGB Lightning Node (RLN) and provides a complete wallet experience: asset management, payments, swaps, and DApp connectivity.

<CardGroup cols={2}>
  <Card title="Multi-Protocol" icon="layer-group">
    Supports RGB, Spark, Arkade (planned), and Liquid (planned)
  </Card>
...
- View **Spark token balances** with asset details
...
| **Spark** | In Progress | Spark protocol adapter |
| **Arkade** | In Progress | Arkade protocol adapter |
