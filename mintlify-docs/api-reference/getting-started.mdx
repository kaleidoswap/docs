...
description: "Start using the KaleidoSwap swap API, with base URLs for signet and mainnet plus authentication, request format, and rate limits"
---
...
For the full status-code list, the error response format, and per-symptom fixes, see [Troubleshooting](/api-reference/troubleshooting).
