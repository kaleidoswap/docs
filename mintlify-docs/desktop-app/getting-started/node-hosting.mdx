---
title: "Self-Host a Multi-Asset Lightning Node"
sidebarTitle: "Node Hosting"
description: "Self-host a multi-asset Lightning node for KaleidoSwap, covering Docker setup, firewall configuration, and remote connection from the Desktop App"
---
