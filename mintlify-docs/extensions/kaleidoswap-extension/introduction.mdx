...
<CardGroup cols={2}>
  ...
  <Card title="DApp Integration" icon="plug">
    Injects standard `window.webln`, `window.webbtc`, and `window.nostr` (NIP-07) providers for trusted DApps
  </Card>
...
- **Nostr provider** (`window.nostr`) implementing NIP-07 event signing and encryption, derived from the recovery phrase
