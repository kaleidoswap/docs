---
title: "Kaleido SDK Troubleshooting"
sidebarTitle: "Troubleshooting"
description: "Diagnose common Kaleido SDK issues — connection failures, version mismatches, and swap errors, with step-by-step solutions"
---
...
<AccordionGroup>
  ...
  <Accordion title="ValidationError: Invalid amount">
    ...
    **Solutions:**
    ...
    2. Ensure you are sending raw amounts (use `parseRawAmount` / `parse_raw_amount`)
    ...
    const amount = parseRawAmount(0.001, 8);
    ```
    ...
    # Convert 0.001 BTC to satoshis (100000)
    amount = parse_raw_amount(0.001, 8)
    ```
    </CodeGroup>
  </Accordion>
