...
<img src="/assets/images/extension/26-bridge-source-picker.png" alt="Bridge source asset picker listing BTC, USDC on Base, and USDT on Ethereum with a search field" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
...
<img src="/assets/images/extension/27-bridge-quote.png" alt="Bridge deposit quote showing amount sent, estimated amount received, fee in basis points, and expiry above the deposit QR code" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />

<img src="/assets/images/extension/28-bridge-deposit-address.png" alt="Bridge deposit address with QR code, copyable address, a waiting for deposit status, and a field to paste the transaction hash" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
...
<Steps>
  ...
  <Step title="Choose Route and Amount">
    Pick the destination asset and enter the amount. By default the amount pins what **you send**, and the quote shows the expected output. On eligible routes you can switch to a **You receive** (exact-out) mode that pins what the recipient gets instead.
  </Step>
...
<img src="/assets/images/extension/30-bridge-withdraw.png" alt="Cross-chain withdrawal detected in the Withdraw flow, with destination network, recipient address, receive token, exact-out amount, and fee" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
...
<img src="/assets/images/extension/29-bridge-tracking.png" alt="Bridge order processing with a six stage progress list from processing to completed, plus the route and order ID" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
