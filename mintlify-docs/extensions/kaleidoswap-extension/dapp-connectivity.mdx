...
description: "Connect the KaleidoSwap Extension to trusted DApps with the WebLN, WebBTC, and Nostr (NIP-07) providers — approval flow, permissions, and supported methods"
---
