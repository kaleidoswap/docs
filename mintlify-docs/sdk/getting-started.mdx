---
title: "Getting Started with the Kaleido SDK"
sidebarTitle: "Getting Started"
description: "Install and configure the Kaleido SDK for TypeScript or Python — clients, endpoints, and your first swap quote in minutes"
---

## Version Compatibility

The current SDK implementation in `kaleido-sdk` (TypeScript) and `kaleido_sdk` (Python) is `v0.1.15`.
