...
| State | Description |
|-------|-------------|
| `OPEN` | Order created, waiting for the deposit |
| `PENDING_PAYMENT` | Deposit detected, awaiting confirmation |
| `PAID` | Payment confirmed, maker processing |
