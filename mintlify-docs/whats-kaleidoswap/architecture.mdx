...
description: "How KaleidoSwap's decentralized architecture works — market makers, RGB Lightning nodes, and LSPs coordinating trustless atomic swaps without custody"
---
...
The platform connects to RGB Lightning Nodes and Lightning Service Providers, all anchored to the Bitcoin blockchain for final settlement. For the broader multi-protocol vision behind this design, read [Solving Bitcoin's L2 liquidity problem](https://kaleidoswap.medium.com/solving-bitcoins-l2-liquidity-problem-kaleidoswap-s-multi-protocol-dex-layer-0725b26f8de4).
