...
2. **Select a Peer** either by inserting the node ID or public key of the peer or by selecting a suggested node. ![channel_peer](/images/desktop-app/channel_peer.png)
3. Specify the amount of Bitcoin to allocate to the channel. This will represent the total capacity of the channel. ![channel_amount](/images/desktop-app/channel_amount.png)
...
This step is required if you want to use the channel to swap one or more RGB assets. ![add_rgb_asset](/images/desktop-app/add_rgb_asset.png)
