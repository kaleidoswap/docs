...
```python Python
response = client.maker.list_assets()
...
```python Python
response = client.maker.list_pairs()
...
```python Python
routes = client.maker.get_pair_routes(GetPairRoutesRequest(...))
...
```python Python
routes = client.maker.get_market_routes(DiscoverRoutesRequest(...))
...
order = client.maker.create_swap_order(CreateSwapOrderRequest(
    rfq_id=quote.rfq_id,
    from_asset=AssetInput(asset_id="BTC", layer="BTC_LN", amount=100000),
    to_asset=AssetInput(asset_id="USDT", layer="RGB_LN", amount=9500),
    receiver_address="lnbc1...",
    min_onchain_conf=1
))
...
```python Python
history = client.maker.get_order_history(status="FILLED", limit=10, skip=0)
...
```python Python
completed = client.maker.wait_for_swap_completion("order-123", options={
    "timeout": 300,
    "poll_interval": 10,
...
```python Python
result = client.maker.init_swap(InitiateSwapRequest(...))
```
</CodeGroup>
...
```python Python
result = client.maker.execute_swap(ConfirmSwapRequest(...))
```
</CodeGroup>
...
```python Python
status = client.maker.get_atomic_swap_status(GetSwapStatusRequest(...))
```
</CodeGroup>
...
```python Python
info = client.maker.get_swap_node_info()
```
</CodeGroup>
...
```python Python
info = client.maker.get_lsp_info()
```
</CodeGroup>
...
```python Python
network_info = client.maker.get_lsp_network_info()
```
</CodeGroup>
...
```python Python
order = client.maker.create_lsp_order(CreateOrderRequest(...))
```
</CodeGroup>
...
```python Python
order = client.maker.get_lsp_order(GetOrderRequest(order_id="lsp-order-123"))
```
</CodeGroup>
...
```python Python
fees = client.maker.estimate_lsp_fees(CreateOrderRequest(...))
```
</CodeGroup>
...
```python Python
result = client.maker.submit_lsp_rate_decision(RateDecisionRequest(...))
```
</CodeGroup>
...
```python Python
result = client.maker.retry_asset_delivery(RetryDeliveryRequest(...))
```
</CodeGroup>
