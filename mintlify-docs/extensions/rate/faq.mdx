...
<AccordionGroup>
  ...
  <Accordion title="Do I need my own node?">
    **Yes.** Rate connects to an RGB Lightning Node (RLN) for core wallet functionality. Without a node connection, you cannot view balances, send, or receive assets.
    ...
    You can connect to:
    - use [Kaleidoswap Desktop App](/desktop-app/wallet/creating-wallet) or run [RGB Lightning Node](https://github.com/RGB-Tools/rgb-lightning-node) on a local machine 
