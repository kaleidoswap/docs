...
![Connecting to a Lightning Service Provider in the Desktop App](/assets/images/desktop-app/12_connect_lsp.png)
...
![LSP channel order form with capacity options](/assets/images/desktop-app/13_channel_order.png)
...
![Channel order form with RGB asset selection](/assets/images/desktop-app/14_channel_order_assets.png)
...
![Channel order payment screen with Lightning invoice](/assets/images/desktop-app/15_pay_the_channel.png)
