...
description: "Open a Lightning channel in the KaleidoSwap Desktop App — choose a peer, set capacity, and add RGB assets for multi-asset trading"
---
...
2. **Select a Peer** either by inserting the node ID or public key of the peer or by selecting a suggested node. ![Peer selection with node ID field and suggested Lightning nodes](/images/desktop-app/16_peer_connection.png)
3. Specify the amount of Bitcoin to allocate to the channel. This will represent the total capacity of the channel. ![Channel capacity selection with Bitcoin amount input](/images/desktop-app/17_channel_amount.png)
...
This step is required if you want to use the channel to swap one or more RGB assets. ![Adding an RGB asset to the new Lightning channel](/images/desktop-app/18_add_rgb_asset.png)
