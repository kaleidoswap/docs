...
description: "Connect the KaleidoSwap Extension to trusted DApps with the WebLN, WebBTC, and Nostr (NIP-07) providers, covering approval flow, permissions, and methods"
---
...
<img src="/assets/images/extension/32-psbt-confirm.png" alt="PSBT signing confirmation decoding the transaction total, each output with its destination and amount, and the network fee" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
...
<img src="/assets/images/extension/34-nostr-connect-bunker.png" alt="Nostr Connect remote signing screen with a listening status, the generated bunker connection string, and a revoke action" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
...
<img src="/assets/images/extension/31-dapp-approval-prompt.png" alt="Connection approval prompt showing the requesting site origin, the access it asks for, and the Reasonable consent default with Deny and Allow actions" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
...
<img src="/assets/images/extension/33-connected-sites.png" alt="Connected Apps screen listing connected apps, Nostr Wallet Connect sessions, and a field to block a site" style={{ maxWidth: "360px", width: "100%", height: "auto", display: "block", margin: "1.5rem auto" }} />
