...
It powers the KaleidoSwap [browser extension](/extensions/introduction), the `rate` mobile wallet, and the [desktop agent](/desktop-app/getting-started/introduction).
