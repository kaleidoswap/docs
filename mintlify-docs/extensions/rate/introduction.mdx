...
Rate is the KaleidoSwap browser wallet for Bitcoin Layer 2 networks. It gives users one popup for Spark, Arkade, optional RGB Lightning Node (RLN), swaps, Nostr identity, and DApp connectivity.
...
<CardGroup cols={2}>
  ...
  <Card title="DApp Integration" icon="plug">
    Exposes `window.rgbwebln` and Nostr signing support to trusted DApps
  </Card>
...
- **Nostr signer** for identity and event signing flows
