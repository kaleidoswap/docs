...
![KS_home.png](/images/desktop-app/0_home.png)

## Create New Wallet

To start the creation process, you first need to select "Create New Wallet" option:

![Create_restore.png](/images/desktop-app/1_create_new_wallet.png)
...
![creation_step1.png](/images/desktop-app/2_creation_step1.png)
...
![Selectaccount_1.png](/images/desktop-app/6_home_with_account.png)
