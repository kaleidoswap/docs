...
| **DApp Support** | WebLN, WebBTC, and Nostr (NIP-07) providers for trusted DApps |
...
- **DApp connectivity** - Inject standard `window.webln`, `window.webbtc`, and `window.nostr` (NIP-07) providers for trusted DApps.
