...
<AccordionGroup>
  ...
  <Accordion title="kaleido-sdk & wallet-engine" icon="code">
    The two SDK surfaces every KaleidoSwap client is built on: `kaleido-sdk` for swap integration (TypeScript and Python, on npm and PyPI, with a Rust core in progress) and `@kaleidorg/wallet-engine` for wallet primitives (TypeScript). Third-party integrations use the same interfaces our own apps do. See the [SDK docs](/sdk/introduction).
  </Accordion>
