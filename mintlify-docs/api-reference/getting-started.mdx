...
Now that you’ve set up your environment and are familiar with the basics, it’s time to explore the endpoints. Proceed to the [RGB LSPS1 APIs](/api-reference/rgb-lsps1-apis) for more details.
