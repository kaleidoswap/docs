...
- **Protocol and network filters** for focusing on BTC, RGB, Spark, Arkade, Bitcoin L1, Lightning, Spark, or Arkade
...
<img src="/images/rate/09-deposit.png" alt="Rate deposit flow" style={{ maxWidth: "360px", width: "100%", height: "auto" }} />
...
<img src="/images/rate/11-settings.png" alt="Rate settings" style={{ maxWidth: "360px", width: "100%", height: "auto" }} />
