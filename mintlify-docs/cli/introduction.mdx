...
Work is split across ten groups. Each one is documented subcommand by subcommand, with its arguments and flags, in [Commands](/cli/command-reference) — this table is the map of what you will find there.
