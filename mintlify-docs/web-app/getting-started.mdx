...
<AccordionGroup>
  ...
  <Accordion title="Connect KaleidoSwap Extension">
    1. Click **Connect**
    2. Select **KaleidoSwap Extension** from the wallet list
    3. Approve the connection in the KaleidoSwap Extension popup
    4. Your address will appear in the header
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Trading Interface" icon="chart-mixed" href="/web-app/how-to-trade">
