---
title: "KaleidoSwap: Non-Custodial Bitcoin DEX on Lightning"
sidebarTitle: "Welcome"
description: "Trade Bitcoin and RGB assets on the Lightning Network with a non-custodial DEX — desktop app, browser extension, SDK, and API for builders and traders"
---

![KaleidoSwap — Trade RGB assets on Lightning](/assets/images/hero-banner.png)

KaleidoSwap is an open-source, [non-custodial Bitcoin DEX](https://kaleidoswap.com) for trading RGB assets on the Lightning Network. Use the **desktop application** for full node control and atomic swaps.
