...
<Tabs>
  <Tab title="Python SDK">
    ...
    [Explore Python SDK →](/sdk/python/index)
  </Tab>
  ...
  <Tab title="TypeScript SDK">
    ...
    [Explore TypeScript SDK →](/sdk/typescript/index)
  </Tab>
...
<CardGroup cols={3}>
  <Card title="Download Desktop App" icon="download" href="/desktop-app/getting-started/installation">
    Install KaleidoSwap and start trading
  </Card>

  <Card title="Explore Documentation" icon="book" href="/desktop-app/getting-started/introduction">
