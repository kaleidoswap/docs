...
![KaleidoSwap Desktop App start screen with node connection options](/assets/images/desktop-app/0_home.png)

## Create New Wallet

To start the creation process, you first need to select "Create New Wallet" option:

![Create New Wallet option in the KaleidoSwap Desktop App](/assets/images/desktop-app/1_create_new_wallet.png)
...
![Wallet creation step 1: account name and network selection](/assets/images/desktop-app/2_creation_step1.png)
...
![Wallet creation step 2: setting a secure password and initializing the node](/assets/images/desktop-app/3_creation_step2.png)
3. **Backup**: After the node has been initialized, write down the mnemonic phrase provided and store it securely.
![Wallet creation step 3: mnemonic backup phrase to write down](/assets/images/desktop-app/4_creation_step3.png)
4. **Verify** recovery phrase: you will be asked to enter back your recovery seed for security purposes.
![Wallet creation step 4: recovery phrase verification](/assets/images/desktop-app/5_creation_step4.png)
...
![KaleidoSwap home screen with saved accounts in the left menu](/assets/images/desktop-app/6_home_with_account.png)
