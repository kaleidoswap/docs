...
description: "Which Kaleido SDK versions work with which Maker API versions — compatibility matrix and upgrade notes"
---

## Compatibility

**SDK v0.1.15** is compatible with the **latest Maker API** version.
