...
Rate is a web extension compatible with browsers:
...
<Steps>
  ...
  <Step title="Build the Extension">
    Go to the repository and build the extension using `pnpm run build`.
  </Step>
...
Rate updates automatically through the Chrome Web Store. For manual installations, pull the latest code, rebuild, and reload the extension on your browser.
