...
description: "A multi-network Bitcoin wallet extension for Spark, Arkade, Liquid, and RGB — swap assets, connect to DApps, and stay self-custodial in your browser"
---
