...
- **MakerClient** (`client.maker`) — market data, quotes, swap orders, atomic swap protocol, LSPS1 channel ordering, WebSocket streaming - **RlnClient** (`client.rln`) — full RGB Lightning Node operations: wallet, BTC, RGB assets, channels, invoices, payments
