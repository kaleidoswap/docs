---
title: 'API Reference'
description: 'Complete method reference for the KaleidoSwap SDK'
---
...
```python Python
routes = client.maker.get_pair_routes({...})
...
```python Python
routes = client.maker.get_market_routes({...})
...
```python Python
status = client.maker.get_swap_order_status({"order_id": "order-123"})
...
```python Python
result = client.maker.submit_rate_decision({
    "order_id": "order-123",
    "accept_new_rate": True
})
# Returns: SwapOrderRateDecisionResponse
...
```python Python
result = client.maker.execute_swap({...})
```
</CodeGroup>
...
```python Python
status = client.maker.get_atomic_swap_status({...})
```
</CodeGroup>
...
```python Python
order = client.maker.create_lsp_order({...})
```
</CodeGroup>
...
```python Python
order = client.maker.get_lsp_order({"order_id": "lsp-order-123"})
```
</CodeGroup>
...
```python Python
fees = client.maker.estimate_lsp_fees({...})
```
</CodeGroup>
...
```python Python
result = client.maker.submit_lsp_rate_decision({...})
```
</CodeGroup>
...
```python Python
result = client.maker.retry_asset_delivery({...})
```
</CodeGroup>
