...
<Note>
  反馈问题时，请附上浏览器及版本、**设置 > 关于**（Settings > About）中显示的扩展版本、复现步骤，以及控制台日志（右键点击弹出窗口，然后选择 **Inspect > Console**）。请先查看[故障排查](/cn/extensions/kaleidoswap-extension/troubleshooting)。
</Note>
