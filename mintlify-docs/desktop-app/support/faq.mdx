...
<AccordionGroup>
  ...
  <Accordion title="What assets can I trade on KaleidoSwap Desktop App?">
    Currently, KaleidoSwap Desktop App supports RGB NIA assets (Non-Inflatable Assets, formerly known as RGB20) on the Lightning Network. These are client-validated smart contracts on Bitcoin that represent fixed-supply fungible tokens.
  </Accordion>
